---
name: localize-fi
description: Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Finnish (Suomi). Finnish is Finno-Ugric, NOT Scandinavian. Enforces the 15-case system with the defining partitive, strict vowel harmony (front ä/ö/y vs back a/o/u), consonant gradation, NO gender, agglutinative possessive suffixes, partitive-singular after numbers 2+ (viisi kissaa), ICU other = partitive singular, sinä/Te formality, impersonal passive status (Tallennetaan…), kirjakieli register, DD.MM.YYYY, and EUR (1 234,56 €).
---
