---
name: localize-ca
description: Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Catalan (Català) for Catalonia, Valencia, the Balearics, or Andorra. Catalan is NOT Spanish. Enforces geminated l·l (interpunct), ç before a/o/u, apostrophe elision (l'aigua), the periphrastic past (vaig + infinitive), weak pronouns en/hi, vostè/tu, «…» quotes, NO inverted ¿¡, EUR 1.234,56 €, and heavy anti-Spanish-calque discipline (desar not guardar, fitxer not archivo, ordinador not ordenador).
---
