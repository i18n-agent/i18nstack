---
name: localize-id
description: Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Indonesian (Bahasa Indonesia). Indonesian is NOT Malaysian — different tech vocabulary (unggah/unduh/pengaturan not muat naik/muat turun/tetapan), 1.234,56 format, Rp Rupiah, day names (Senin/Kamis). Enforces the affix system (me-/di-/ber-/-kan/-i) with nasal assimilation, mandatory -kan on transitives, me- after untuk, reduplication for plurals, Anda/kamu formality, formal register over slang, and religious sensitivity.
---
