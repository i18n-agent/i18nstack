---
name: localize-pl
description: Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Polish (pl). Enforces 7-case grammar with active vocative (użytkowniku!), 3-gender system with masculine-personal vs non-masculine-personal plural split, ICU one/few/many/other plurals, perfective/imperfective aspect, Pan/Pani + 3rd-person formal address, diacritics ą ć ę ł ń ó ś ź ż (ł essential), impersonal status voice (never first-person Obliczam), neuter perfective participle (Zapisano), imperative buttons (Zapisz), and PLN złoty (99,99 zł).
---
