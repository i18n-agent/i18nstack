---
name: localize-sw
description: Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Swahili (Kiswahili) for East Africa (Tanzania, Kenya, Uganda, and beyond). Bantu, NOT Arabic. Enforces the defining NOUN CLASS SYSTEM (15-18 classes with concord spreading through the sentence), agglutinative verb morphology with tense markers (-na-/-li-/-ta-/-me-), NO gender, post-nominal adjectives with concord (faili kubwa), ng' as a distinct letter, ICU one/other plurals, imperative buttons (Hifadhi, Futa), Kiswahili sanifu register (not Sheng), country-varying currency, and cross-EAC neutrality.
---
