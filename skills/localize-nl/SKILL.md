---
name: localize-nl
description: "Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Dutch (nl) for the Netherlands (default), Belgium/Flemish, or Suriname/Caribbean. Enforces de/het article correctness (the biggest bug source), strong/weak adjective endings, V2 word order with verb-final subordinate clauses, separable verbs, je/u formality with matching possessives (u+uw, je+jouw), 1.234,56 numbers, DD-MM-YYYY with hyphens, EUR, lowercase months, and calque avoidance (verwijderen not deleten, annuleren not cancelen)."
---
