---
name: localize-hi
description: "Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Hindi (हिन्दी). Devanagari, NOT Urdu/Nastaliq. Enforces SOV with verb last, 2 genders, आप as universal UI default (never तू/तुम), the ergative ने construction (verb agrees with object), postpositions with oblique case, noun+करना compound verbs (क्लिक करना), Indian lakh/crore grouping (₹1,23,456), nukta dots (फ़/ज़), tech loanwords over Sanskritic coinages, DD/MM/YYYY, and ₹ Rupee."
---
