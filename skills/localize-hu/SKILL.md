---
name: localize-hu
description: "Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Hungarian (Magyar). Finno-Ugric agglutinative, NO gender. Enforces 18 case-suffixes, strict vowel harmony, definite vs indefinite conjugation (mentjük vs mentünk), Ön/te formality (Ön = 3rd person), separable verbal prefixes, focus-position word order, SINGULAR noun after numbers (öt fájl), adjective loanword adaptation (globális), native verbs (kattintani not klikkelni), „…” quotes, YYYY. MM. DD. dates, Forint (1 234 Ft), and noun-form buttons (Mentés)."
---
