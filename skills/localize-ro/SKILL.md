---
name: localize-ro
description: "Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Romanian (Română). The only major Romance language with a THREE-gender system (neuter = masc.sg + fem.pl). Enforces the postposed definite article (utilizatorul, pagina), genitive-dative endings (-ului/-ei/-elor), diacritics ă/â/î/ș/ț (comma-below ș/ț NOT cedilla), ICU one/few/other with „de” before nouns 20+ (20 de fișiere), Dumneavoastră/tu formality, „99-66” quotes, 1.234,56 numbers, RON Lei, false-friend avoidance (actual=current), and native verbs (a șterge not a deleta)."
---
