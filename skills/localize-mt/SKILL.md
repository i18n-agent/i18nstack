---
name: localize-mt
description: "Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Maltese (Malti). The only Semitic language in Latin script — NOT Arabic, NOT Italian. Enforces special letters Ċ Ġ Ħ Ż (never strip), digraphs GĦ and IE, definite article il- with sun-letter assimilation, root-and-pattern morphology with broken plurals, 2-gender agreement with post-nominal adjectives, 5-form ICU plurals, ma…x double negation, 1,234.56 numbers, EUR €1,234.56, and DD/MM/YYYY or '15 ta' Jannar'."
---
