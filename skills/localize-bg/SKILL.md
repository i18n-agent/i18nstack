---
name: localize-bg
description: "Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Bulgarian (bg). Bulgarian is NOT Russian or Serbian — the one Slavic language that lost noun cases. Enforces the suffixed definite article (момче→момчето), 3 genders, analytic ще future, ICU one/other plurals, masculine count form after numbers (два файла), Вие/ти formality, „…“ quotes, 1 234,56 format, BGN лв, and anglicism rejection (потребител not юзър)."
---
