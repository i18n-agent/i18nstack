---
name: localize-ga
description: "Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Irish/Gaeilge. Irish is Goidelic Celtic, NOT Brittonic (Welsh). Enforces two mutation systems (séimhiú lenition, urú eclipsis), VSO word order, broad/slender consonant orthography, the fada (á é í ó ú), copula `is` vs verb `tá`, inflected prepositional pronouns (agam/agat), singular noun after 1-10 with range-based mutation, verbal-noun buttons (Sábháil), EUR €1,234.56 (Anglo format), and Béarlachas (anglicism-calque) avoidance."
---
