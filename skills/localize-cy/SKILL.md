---
name: localize-cy
description: "Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Welsh (cy / Cymraeg). Welsh is Brittonic Celtic, NOT Irish/Gaelic. Enforces the three initial consonant mutations (soft/nasal/aspirate — part of spelling), VSO word order, the 29-letter alphabet with 8 digraphs (ch, dd, ff, ng, ll, ph, rh, th), to-bach circumflex (â ê î ô û ŵ ŷ), inflected prepositions, chi/ti formality, verbal-noun buttons (Cadw), singular noun after 1-10, 6-form ICU plurals, GBP £, and 1,234.56 format."
---
