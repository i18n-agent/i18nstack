---
name: localize-bn
description: Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Bengali (বাংলা) for Bangladesh (bn-BD) and India (bn-IN). Bengali is NOT Hindi — Eastern Nagari script, NO gender, SOV. Enforces 3-tier honorifics (আপনি default), mandatory classifiers with numbers, animate/inanimate plurals (-রা/-গুলো), attached case postpositions, করা compound verbs, conjunct consonants, lakh/crore grouping, and BDT (৳) vs INR (₹) by region.
---
