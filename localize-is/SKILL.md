---
name: localize-is
description: Use when translating or localizing UI strings, marketing copy, documentation, or any source text into Icelandic (is). Enforces EXTREME purism — native coinages for modern concepts (tölva, vafri, tölvupóstur, lykilorð), loanwords rejected (never kompjúter/deleta/updatea). Also ð/þ and æ/ö preservation, 4-case grammar with preposition-governed case, 3 genders with strong/weak adjectives, declining suffixed definite articles, V2 word order, person-based verb conjugation, þú-only formality, ISK króna (9.999 kr., no decimals), and DD.MM.YYYY.
---
